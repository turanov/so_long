...
**
** Il i a des differences entre X11 et MacOS.
...
/*
**  origin for j & i is top left corner of the window
**  i down is positive
**  color is 0x00RRGGBB
*/
...
**   mouse_hook(int button, int j,int i, void *param);
